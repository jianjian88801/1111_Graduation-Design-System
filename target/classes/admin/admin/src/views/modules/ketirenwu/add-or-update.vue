        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='jiaoshi'">
                    <el-form-item class="select" v-if="type!='info' && role != '学生'"  label="教师" prop="jiaoshiId">
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info' && role != '学生'"  label="教师姓名" prop="jiaoshiName">
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info' && role != '学生'"  label="手机号" prop="jiaoshiPhone">
                ...
                <el-col :span="12"  v-if="sessionTable !='xuantishenqing'">
                    <el-form-item class="select" v-if="type!='info' && role != '学生'"  label="选题申请" prop="xuantishenqingId">
                ...
                <el-col :span="12"  v-if="sessionTable !='xuantishenqing' ">
                    <el-form-item class="input" v-if="type!='info' && role != '学生'"  label="课题编号" prop="xuantishenqingUuidNumber">
            ...
            <input id="xuantishenqingId" name="xuantishenqingId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info' && role != '学生'"  label="课题任务" prop="ketirenwuName">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info' && role != '学生'"  label="任务类型" prop="ketirenwuTypes">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.ketirenwuFile && role != '学生'" label="参考文献" prop="ketirenwuFile">
                        <file-upload
                                tip="点击上传参考文献"
                                action="file/upload"
                                :limit="3"
                ...
                <el-col :span="12" v-if="(role=='教师' && type=='info') || role == '管理员' || role == '学生'">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.ketirenwuYesnoText" label="教师打分" prop="ketirenwuYesnoText">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   ketirenwuYesnoText: [
                              { required: true, message: '教师打分不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
